...
const AssuranceSection = () => {
  return (
<div className="flex items-center  flex-col lg:flex-row justify-center py-20 assurance_main">
            <div className="assurance_section my-12 lg:my-0 ">
            ...
            <div className="w-px bg-gray-500 mx-12 my-12 lg:my-0 assurance_partition"></div>
            ...
            <div className="w-px bg-gray-500 mx-16 my-12 lg:my-0 assurance_partition"></div>
