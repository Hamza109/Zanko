...
const SignUp = ({ toggleForm }) => {
  return (
    ...
    <div className="form-box w-full  text-white purple-shadow  border-login"  style={{margin:20}}>
    <div className="inner-content-login bg-black">
    <h2 className="text-3xl font-bold mb-2">Sign up</h2>
  <hr className="border-t-4 border-white mb-6" style={{width:115}} />
<form className="space-y-4">
  ...
  <div className="input-box relative">
    <input type="email" required className="w-full p-2 bg-gray-800 border-none text-white rounded-md" />
    <label className="absolute top-0 left-0 p-2 text-white transform translate-y-1/2 transition-all">
     Email
    </label>
  </div>
  <div className="input-box relative">
          ...
          <label className="absolute top-0 left-0 p-2 text-gray-400 transform translate-y-1/2 transition-all">
            Password
          </label>
        </div>
        <div className="input-box relative">
...
<p className=" text-center login-footer text-gray-400 my-4">
        ...
        Already have an account? <span onClick={toggleForm} className="text-white font-semibold cursor-pointer">Login</span>
      </p>
</div>
</div>
